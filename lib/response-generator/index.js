...
class ResponseGenerator {
    ...
    if(fakerExtension)
      try { return this.generateByFaker(fakerExtension, path) }
      catch(e) { logger.warn(`Failed to generate fake result using ${fakerExtension} schema. Falling back to primitive type.`) }
  ...
  static generateByAllOf(allOf, path) {
    ...
    let examples = schemaResponse.examples
